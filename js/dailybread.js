...
OpenSpending.DailyBread = function (elem) {
  ...
  this.init = function () {
    this.setSalary(1000000) // default starting salary
  ...
  this.drawIcons = function(t) {
    ...
    $('.db-area-icon', t).each(function(i,e) {
      ...
      paper.circle(iconRad,iconRad,iconRad).attr({ fill: '#FF9933', stroke: 'none' });
...
OpenSpending.renderDependentTypes = function(db) {
  function draw(iconPath, target, selected) {
    ...
    r.circle(iconRad,iconRad,iconRad).attr({ fill: '#FF9933', stroke: 'none' });
